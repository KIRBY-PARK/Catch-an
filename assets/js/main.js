...
intro
    .addLabel('a')
    .from(".jn-intro .text:first-child",{autoAlpha:0, x:-180, duration:1.5,delay:1},'a')
    .from(".jn-intro .particle2",{rotate:360,autoAlpha:0,duration:0.2,delay:1.7},'a')
    .from(".jn-intro .main-text",{autoAlpha:0, x:-90,delay:1.25, duration:1.5},'a')
    .from(".jn-intro .text:nth-child(3)",{autoAlpha:0, x:-45,delay:1.5,duration:1.5},'a')
    .from(".jn-intro .particle3",{rotate:-180,autoAlpha:0,duration:0.2,delay:2.2},'a')
    .from(".jn-intro .mini-text",{autoAlpha:0, y:50, rotate:5, delay:2.5,duration:0.6},'a')
    .from(".jn-intro .img-box",{autoAlpha:0,yPercent:30,duration:0.4,delay:3.5},'a')

const intro2 = gsap.timeline();
intro2
    .addLabel('a')
    .to(".jn-intro .particle1",{autoAlpha:0, scale:1.8, yPercent:-30},'a')
    .fromTo(".jn-intro .particle2",{rotate:0,xPercent:0,yPercent:0},{rotate:-30,xPercent:15,yPercent:10,duration:1},'a')
    .fromTo(".jn-intro .particle3",{rotate:0},{rotate:10,duration:1},'a')
    .fromTo(".jn-intro .img-box",{rotate:0,yPercent:0},{rotate:2,yPercent:8,duration:1},'a')
...
marquee
    .addLabel('a')
    .from(".jn-about .marquee1 .wrap",{xPercent:-90},'a')
    .to(".jn-about .marquee2 .wrap",{xPercent:-50},'a')
    .from(".jn-about .marquee3 .wrap",{xPercent:-70},'a')
ScrollTrigger.create({
    animation: marquee,
    trigger: ".jn-about",
    start: "top 80%",
...
aboutParticle
    .addLabel('a')
    .fromTo(".jn-about .particle",{rotate:-80, xPercent:100, yPercent:200},{rotate:20, xPercent:-10, yPercent:-10},'a')
ScrollTrigger.create({
    animation: aboutParticle,
    trigger: ".jn-about .particle-wrap",
    start: "top 80%",
    end: "top 15%",
    scrub: true,
    pin: false,
...
workParticle
    .addLabel('a')
    .from(".jn-work .particle",{xPercent:-30, yPercent:-40,rotate:15},'a')
ScrollTrigger.create({
    animation: workParticle,
    trigger: ".jn-work .particle-wrap",
    start: "top 100%",
    end: "top 35%",
    scrub: true,
    pin: false,
